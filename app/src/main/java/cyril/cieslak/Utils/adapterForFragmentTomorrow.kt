...
class adapterForFragmentTomorrow (
    ...
    var lindexAtZero = "$leTomorrow $MIDNIGHT"
    var lindexAtOne = "$leTomorrow $THREEAM"
    var lindexAtTwo = "$leTomorrow $SIXAM"
    var lindexAtThree = "$leTomorrow $NINEAM"
    var lindexAtFour = "$leTomorrow $NOON"
    var lindexAtFive = "$leTomorrow $THREEPM"
    var lindexAtSix = "$leTomorrow $SIXPM"
    var lindexAtSeven = "$leTomorrow $NINEPM"
